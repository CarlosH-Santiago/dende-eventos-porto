...
data class Organizador(
    ...
    var senha: String,
    // [Critério 7 - val/var em Data Class] 'cnpj', 'razaoSocial' e 'nomeFantasia' são 'var' com padrão null, correto — dados opcionais que podem ser adicionados ou editados.
    // [Critério 17 - Valor Inicial em Data Class] 'null' como valor padrão faz sentido para dados opcionais de empresa.
    var cnpj: String? = null,
    var razaoSocial: String? = null,
    var nomeFantasia: String? = null,
    // [Critério 7 - val/var em Data Class] 'ativo' é 'var', correto — pode ser desativado/reativado (US 5 e 6).
    // [Critério 17 - Valor Inicial em Data Class] 'true' como padrão faz sentido — organizador nasce ativo após o cadastro.
